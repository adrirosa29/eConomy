...
export default function App() {
  ...
  const manualInvestments = useMemo(() => {
    return visibleManualAssets
      ...
      .map((a) => {
        ...
        return { name: a.name, currentValue: a.value, costBasis, gain: a.value - costBasis };
      });
  ...
  }, [pnlYear, netWorthValueKey, reconstructedNetWorth, pnlYearsAvailable, currentMonthKey]);
  ...
  const manualInvestmentGainByMonth = useMemo(() => {
    const map = {};
    visibleManualAssets.filter((a) => a.isInvestment).forEach((a) => {
      const key = a.name.trim().toLowerCase();
      const history = manualHistoryByMonth[key] || [];
