    ...
    <div style={{ fontFamily: FONT, background: PALETTE.cover, minHeight: "100vh", color: PALETTE.ink }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        {activeTab === "patrimonio" && (
          <section style={{ background: PALETTE.paper, borderRadius: 4, padding: "48px 32px", textAlign: "center" }}>
            <p style={{ fontFamily: FONT, fontSize: 20, fontWeight: 600, color: PALETTE.ink, margin: "0 0 8px" }}>Patrimonio</p>
            <p style={{ fontSize: 13, color: PALETTE.inkSoft, margin: 0, maxWidth: 380, marginLeft: "auto", marginRight: "auto" }}>
              Esta pestana esta reservada para mas adelante: aqui podras ver una foto de tus ahorros, inversiones y propiedades a lo largo del tiempo, mas alla de los ingresos y gastos del dia a dia.
            </p>
          </section>
        )}
