...
export default function App() {
  ...
  const resumenRows = useMemo(() => {
    ...
    return rows.map((r) => ({ ...r, savings: r.income - r.expense }));
  ...
  const sharedStyle = (
    <style>{`
      ...
      .tab-btn {
        ...
        border-bottom: 2px solid transparent; color: rgba(237,228,211,0.55); cursor: pointer;
      }
    ...
    return (
      <div style={{ fontFamily: "'IBM Plex Sans', Georgia, serif", background: PALETTE.cover, minHeight: "100vh", color: PALETTE.ink, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
        ...
        <div style={{ maxWidth: 380, width: "100%" }}>
          ...
          <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 12, letterSpacing: 2, color: "rgba(237,228,211,0.55)", margin: "0 0 4px", textAlign: "center" }}>
            eConomy
          </p>
          ...
          <p style={{ fontSize: 11, color: "rgba(237,228,211,0.45)", marginTop: 18, textAlign: "center", lineHeight: 1.5 }}>
    ...
    <div style={{ fontFamily: "'IBM Plex Sans', Georgia, serif", background: PALETTE.cover, minHeight: "100vh", color: PALETTE.ink }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "40px 24px 80px" }}>
        <header style={{ marginBottom: 20, display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, flexWrap: "wrap" }}>
          <div>
            <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 12, letterSpacing: 1, color: "rgba(237,228,211,0.55)", margin: "0 0 4px" }}>
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <button onClick={handleLogout} style={{ background: "none", border: "none", color: "rgba(237,228,211,0.6)", fontSize: 12, cursor: "pointer", padding: 0 }}>Cerrar sesion</button>
          </div>
        </header>

        <nav style={{ display: "flex", gap: 24, borderBottom: `1px solid rgba(237,228,211,0.15)`, marginBottom: 24 }}>
          {TABS.map((t) => (
          ...
          <>
            <section style={{ background: PALETTE.coverSoft, borderRadius: 4, padding: "16px 24px", marginBottom: 20, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
              <div>
                ...
                <p style={{ fontSize: 12, color: "rgba(237,228,211,0.6)", margin: 0 }}>{importMsg || "Sube un archivo .json exportado desde Excel para anadirlo a tu registro."}</p>
              </div>
        ...
        {storageError && (
          <p style={{ marginTop: 16, fontSize: 12, color: "rgba(237,228,211,0.7)" }}>No se pudo guardar en este momento. Tus datos de esta sesion siguen visibles, pero podrian no persistir.</p>
        )}
      </div>
    </div>
  );
