...
export default function App() {
  ...
  // "Apuestas" queda fuera de este "beneficio/perdida de inversiones": es
  // otro tipo de inversion y se contabiliza aparte (ver manualBettingGain).
  const allPnlMonthsSorted = useMemo(() => {
    const investmentMonths = visibleManualAssets
      .filter((a) => a.isInvestment && a.category !== "Apuestas")
  ...
  const manualInvestmentGainByMonth = useMemo(() => {
    const map = {};
    visibleManualAssets.filter((a) => a.isInvestment && a.category !== "Apuestas").forEach((a) => {
      const key = a.name.trim().toLowerCase();
      const history = manualHistoryByMonth[key] || [];
