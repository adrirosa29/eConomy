              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: openPositionsExpanded ? 14 : 0, flexWrap: "wrap", gap: 10 }}>
                ...
                {openPositionsExpanded && (
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <button
                      type="button"
                      onClick={() => { setEditingHoldingId(null); setHoldingForm({ symbol: "", quantity: "", kind: "stock", openPrice: "", openDate: todayISO(), commission: "" }); setSymbolPickedName(""); setSymbolResults([]); setAddHoldingModalOpen(true); }}
