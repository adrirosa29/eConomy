                ...
                >
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px 12px", marginBottom: 14 }}>
                    <div style={{ gridColumn: "1 / -1" }}>
                      ...
                      <input className="ledger-input" autoFocus autoCapitalize="characters" placeholder="Ej. AAPL o BTC/USD" value={holdingForm.symbol} onChange={(e) => setHoldingForm({ ...holdingForm, symbol: e.target.value })} />
                    </div>
                    <div>
